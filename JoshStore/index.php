...
<head>
	<meta charset="utf-8">
	<title>Josh Store | Online Shopping</title>
...
<body>
	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">Josh Store</a>
			</div>

			<ul class="nav navbar-nav">
				<li style="width:250px;left:10px;top:10px;"><input type="text" class="form-control" id="search" name=""></li>
	...
	<!-- Slider Begins -->
	 ...
	 <div class="one-time">
	    <div><img src="assets/images/cars1.jpg"></div>
	    <div><img src="assets/images/cars2.jpg"></div>
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="panel panel-info">
					...
					<div class="panel-footer">&copy; 2018 Josh Store</div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
...
<p> Made By <a href="#" data-toggle="tooltip" title="Hey there, Happy Shopping!">Joshua</a></p>
</footer></div>
<style> 
